...
from pteacher.data.common import (
...
def divide_label_unlabel(
    ...
    # if "blance" not in random_data_seed_path:
    #     assert labeled_idx.shape[0] == num_label, "Number of READ_DATA is mismatched. {} vs {}".format(labeled_idx.shape[0], num_label)
...
def build_detection_semisup_train_loader(cfg, mapper=None):
    ...
    return build_batch_data_loader(
        dataset,
        sampler,
        cfg.SOLVER.IMS_PER_BATCH_LABEL * 2,
