...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='organoids_0806_train_edge', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./pix2pixHD-master/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--config', type=str, default='./', help='no used param')
        self.parser.add_argument('OUTPUT_DIR', type=str, default='./', help='no used param')
        self.parser.add_argument('./maskrcnn/0902_1', type=str, default='./', help='no used param')

        # input/output sizes       
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=512, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=512, help='then crop to this size')
        self.parser.add_argument('--label_nc', type=int, default=50, help='# of input label channels')
        ...
        self.parser.add_argument('--ngf', type=int, default=40, help='# of gen filters in first conv layer')
